...
def register(s) -> None:
    ...
    s.has("clipboard key prime", read(SHELL / "modules" / "clipboard" / "Clipboard.qml"), "KeyPrime")
    s.has("overview key prime", read(SHELL / "modules" / "overview" / "Overview.qml"), "KeyPrime")
